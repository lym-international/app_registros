...
@Component({
    ...
    imports: [MatIconButton, MatIcon, CdkScrollable, MatDialogContent, FormsModule, ReactiveFormsModule, MatFormField, MatLabel, MatInput, MatSuffix, MatError, MatDatepickerInput, MatDatepickerToggle, MatDatepicker, MatSelect, MatOption, MatButton, MatDialogClose]
})
